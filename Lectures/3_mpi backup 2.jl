...
* [Many implementations](https://www.mpi-forum.org/implementation-status/):
  - MPICH, from $(img("https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/ArgonneLaboratoryLogo.png/150px-ArgonneLaboratoryLogo.png", :height => "20pt")) and $(img("https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Mississippi_State_University_logo.svg/150px-Mississippi_State_University_logo.svg.png", :height => "20pt"))
  - Open MPI $(img("https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Open_MPI_logo.png/150px-Open_MPI_logo.png", :height => "20pt")) (not to be confused with $(img("https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/OpenMP_logo.png/150px-OpenMP_logo.png", :width => "45pt")))
  - commercial implementations from $(img("https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Hewlett_Packard_Enterprise_logo.svg/150px-Hewlett_Packard_Enterprise_logo.svg.png", :height => "20pt")), $(img("https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Intel_logo_%282020%2C_dark_blue%29.svg/150px-Intel_logo_%282020%2C_dark_blue%29.svg.png", :height => "15pt")), $(img("https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Microsoft_logo_%282012%29.svg/150px-Microsoft_logo_%282012%29.svg.png", :height => "15pt")), and $(img("https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/NEC_logo.svg/150px-NEC_logo.svg.png", :height => "15pt"))
"""
...
* Select $(img("https://www.ceci-hpc.be/assets/img/new_ceci_logo.png", :height => "15pt")) cluster from [the list](https://www.ceci-hpc.be/clusters.html) + `manneback` for GPU. You only have access to Tier-2 clusters. This sadly leaves out:
  ...
  - Tier-0 cluster such as $(img("https://www.lumi-supercomputer.eu/wp-content/uploads/2020/02/lumi_logo.png", :height => "15pt")) from $(img("https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/HPC_JU_logo_RGB.svg/150px-HPC_JU_logo_RGB.svg.png", :height => "20pt"))
* Connect with SSH using `ssh lemaitre4` or `ssh manneback`.
"""

# ╔═╡ 55e96151-2aa1-4ea0-b672-2038c57d911e
aside(img("https://upload.wikimedia.org/wikipedia/en/thumb/3/3e/The_LUMI_supercomputer.jpg/400px-The_LUMI_supercomputer.jpg", :height => "100pt"), v_offset = -140)
...
md"""
$(img("https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Slurm_logo.svg/200px-Slurm_logo.svg.png", :width => "160px", :height => "160px"))
...
The bisection width is 1 : $(img("https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Bisected_linear_array.jpg/600px-Bisected_linear_array.jpg", :width => "300pt"))
""")

# ╔═╡ 23bfbe95-7ba2-41b9-bd8b-dc4baa3ad53a
Foldable(md"What is the bisection width ?", md"""
The bisection width is 2:
$(img("https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Bisected_ring.jpg/600px-Bisected_ring.jpg", :width => "300pt"))
""")
...
md"""
It is ``n = \sqrt{|V|}``:
$(img("https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Bisected_mesh.jpg/600px-Bisected_mesh.jpg", :width => "300pt"))
...
$(img("https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Bisected_tree.jpg/400px-Bisected_tree.jpg") )
""")

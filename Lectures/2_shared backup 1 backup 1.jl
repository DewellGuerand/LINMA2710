...
We use the high level $(img(URL("https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/OpenMP_logo.png/150px-OpenMP_logo.png"), :width => "45pt")) library in this course.
""", v_offset = -1000)
